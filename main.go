...
func main() {
	...
	translatehead = "You are a translator. The following passages are from the Japanese GalGame dialogue. Please translate it into simplified Chinese and keep the original format. Do not reply to this sentence or translate punctuation mark"
